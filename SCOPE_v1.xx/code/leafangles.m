function [lidf,litab,nli]=  leafangles(a,b)                                     
...
%
%% main function
% The below values for lidf were calculated using a particular leaf inclination discretization (litab)
litab       =   [ 5:10:75 81:2:89 ]';
nli         =   length(litab);
